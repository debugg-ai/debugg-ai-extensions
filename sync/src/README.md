...
The first time, a Merkle tree of the codebase folder is constructed, ignoring any files in .gitignore or .debuggignore. Every file found will be returned as needing to be computed added to the index.

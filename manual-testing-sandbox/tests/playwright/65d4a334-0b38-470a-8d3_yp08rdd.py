...
async def run_generated_script():
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            context = await browser.new_context(permissions=['clipboard-read', 'clipboard-write'], record_video_dir='/app/backend/media/tmp6mgdh2w5.gif', no_viewport=True)
            ...
            # --- Step 1 ---
            # Action 1
            await _try_locate_and_act(page, "xpath=//html/body/div[1]/div/main/div/div/section[2]/p/button", "click", step_info="Step 1, Action 1")
            ...
            final_message = replace_sensitive_data("The target URL is currently offline and inaccessible due to the ngrok endpoint being down. Therefore, I cannot verify the background gradient or font style as requested. Task cannot be completed.", SENSITIVE_DATA)
            print(final_message)

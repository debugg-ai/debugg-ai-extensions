...
async def run_generated_script():
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            context = await browser.new_context(permissions=['clipboard-read', 'clipboard-write'], record_video_dir='/app/backend/media/tmp2y8ocr8d.gif', no_viewport=True)
            ...
            final_message = replace_sensitive_data("TUNNELING ERROR - The ngrok endpoint is offline and the page cannot be accessed to verify the header and button styles as requested. Task failed due to this error.", SENSITIVE_DATA)
            print(final_message)

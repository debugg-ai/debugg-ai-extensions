...
export interface E2esService {
    createE2eTest(fileContents: Uint8Array, filePath: string, repoName: string, branchName: string, params?: Record<string, any>): Promise<E2eRun | null>;
...
export const createE2esService = (tx: AxiosTransport): E2esService => ({
    ...
    async getE2eRun(
        ...
        try {
            const serverUrl = `api/v1/e2es/runs/${uuid}/`;
    ...
    async getE2eTest(
        ...
        try {
            const serverUrl = `api/v1/e2es/tests/${uuid}/`;

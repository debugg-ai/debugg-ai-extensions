...
describe("shouldIgnore", () => {
  ...
  test("should return true if a folder is ignored by .debuggignore", async () => {
    addToTestDir([
      ["ignored-folder/file.txt", "content"],
      [".debuggignore", "ignored-folder/"],
    ]);
  ...
  test("should return true if a .debuggignore override ignores file", async () => {
    addToTestDir([
      ["override-file.txt", "content"],
      [".gitignore", "override-file.txt"],
      [".debuggignore", "!override-file.txt"],
    ]);
    const result = await shouldIgnore(
  ...
  test("should return true for deeply nested file ignored by ignore files at multiple levels", async () => {
    addToTestDir([
      ...
      ["level1/level2/.debuggignore", "level3/"],
    ]);
    const result = await shouldIgnore(
